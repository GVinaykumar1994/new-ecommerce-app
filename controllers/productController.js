         ...
         case !name:
          return res.status(500).send({error:"Name is required"});
                    ...
                    case photo && photo.size > 1000000:
                            return res.status(500).send({error:"photo is required and should be lessthan 1mb"});
...
export const getProductController =async (req, res) => {
    try {
        //below line is load images at last and up 12images for running application fast
